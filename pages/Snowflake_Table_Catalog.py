...
# <div class="extra content">
#     <button class="btn button-1" role="button"><i class="eye icon"></i> Preview</button>
#     <button class="btn button-2 download icon" role="button"><i class="download icon"></i> Download CSV</button>
# </div>